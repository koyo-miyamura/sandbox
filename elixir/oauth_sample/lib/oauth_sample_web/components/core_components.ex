defmodule OauthSampleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OauthSampleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OauthSampleWeb.Gettext, "errors", msg, opts)
    end
  end
